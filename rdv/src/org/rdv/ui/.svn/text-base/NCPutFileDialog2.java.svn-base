...
public class NCPutFileDialog2 extends JDialog implements ActionListener
{
    private JPanel myPanel = null;
    private JButton yesButton = null;
    private JButton noButton = null;
    private boolean success = false;
    private static Log log=LogFactory.getLog(NCPutFileDialog2.class.getName());
    ...
    public NCPutFileDialog2(JFrame frame)
	{
        super(frame, "Export Data to NEESCentral", true);
		...
		Action foobar3 = new AbstractAction(){
			public void actionPerformed(ActionEvent e){
				...
				localFile = UIUtilities.getFile("Select", "Select file to upload to NEESCentral");
		...
		panel.setBorder(new TitledBorder("Enter NEESCentral path to store this file"));	  
